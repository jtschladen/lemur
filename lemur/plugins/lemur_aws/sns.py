...
def publish(topic_arn, certificates, notification_type, notification_id, **kwargs):
...
def publish_single(sns_client, topic_arn, certificate, notification_type, notification_id, subject):
    response = sns_client.publish(
        TopicArn=topic_arn,
        Message=format_message(certificate, notification_type, notification_id),
        Subject=subject,
    )
...
def format_message(certificate, notification_type, notification_id):
    json_message = {
